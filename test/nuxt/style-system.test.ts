  ...
  setup() {
    return () =>
      h('div', { 'data-testid': 'style-fixture' }, [
        ...
        h('div', { 'data-testid': 'surface-card', class: 'bg-surface border-border rounded-card shadow-card p-6' }, 'Card.'),
        ...
        h('button', { 'data-testid': 'control-button', type: 'button', class: 'bg-action text-on-action px-4 py-2 rounded-control' }, 'Action'),
